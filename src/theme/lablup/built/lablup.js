...
/**
 * lablup theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { lablupTheme } from './lablup';
 *   import './lablup.css';
 */
export const lablupTheme = {
  name: 'lablup',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "\"Ubuntu Sans\", \"Pretendard Variable\", -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif",
    "--font-family-heading": "\"Ubuntu Sans\", \"Pretendard Variable\", -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif",
    ...
    "--color-accent": "light-dark(#AC3600, #FFB684)",
    ...
    "--color-on-accent": "light-dark(#FFFFFF, #651000)",
    ...
    "--color-success": "light-dark(#007a63, #03a487)",
    "--color-error": "light-dark(#c82333, #dc4446)",
    "--color-warning": "light-dark(#9a5d00, #d89614)",
    ...
    "--color-border": "light-dark(#211A161A, #F9EFE81A)",
